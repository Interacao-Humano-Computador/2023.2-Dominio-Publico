# Planejamento da avaliação da etapa de Design, Avaliação e Desenvolvimento do grupo 5
...
O método que utilizaremos nesta avaliação será uma inspiração nos 6 passos criados por Fagan, com algumas alterações.
Os passos serão:
...
- Inspetores estudam individualmente os artefatos, fazendo anotações e gerando uma lista de discrepâncias.
...
Nesta fase, as avaliações serão feitas em dupla, entre os integrantes Ana Catarina Santos e Pedro Henrique.
