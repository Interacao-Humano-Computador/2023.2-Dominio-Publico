...
A finalidade da avaliação foi verificar a concordância entre a HTA de "Fazer download da mídia" e o fluxo de interações dos utilizadores do Domínio Público, ao mesmo tempo em que identificamos oportunidades de aprimoramento visando proporcionar um suporte mais eficiente e satisfatório aos usuários.
...
A finalidade da avaliação foi verificar a concordância entre a HTA de "Se tornar um colaborador" e o fluxo de interações dos utilizadores do Domínio Público, ao mesmo tempo em que identificamos oportunidades de aprimoramento visando proporcionar um suporte mais eficiente e satisfatório aos usuários.
...
No Video 4 e Tabela 8 é possível verificar os registros feitos durante a avaliação.
...
No Video 5 e Tabela 10 é possível verificar os registros feitos durante a avaliação.
...
A finalidade da avaliação foi verificar a concordância entre a HTA de "Contatar administradores" e o fluxo de interações dos utilizadores do Domínio Público, ao mesmo tempo em que identificamos oportunidades de aprimoramento visando proporcionar um suporte mais eficiente e satisfatório aos usuários.
...
No Video 7 e Tabela 14 é possível verificar os registros feitos durante a avaliação.
