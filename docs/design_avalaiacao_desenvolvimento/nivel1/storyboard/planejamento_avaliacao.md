...
- Verificar se as tarefas representadas estão de acordo com a realidade dos usuários.
- Se todas as necessidades são representadas e satisfeitas.
- Se os storyboards realmente representam sua tarefa.
...
<a href="/home/harryson/Documentos/2023.2-Dominio-Publico/docs/analise_de_requisitos/aspectos_eticos.md" > Termo de Consentimento </a> .
...
Na parte inicial do encontro será disponibilizado termo de consentimento para acordo das partes, o entrevistador deve fazer essa mediação. A partir disso será realizado uma sequêcia de perguntas propostas.
